  ...
  async function loadAll(){
    ...
    if(current.role_code==="ADMIN"){
      const [kpiResult,profileResult]=await Promise.all([
        ...
        supabase.rpc("get_kpi_evaluation",{p_week_slot:null}),
