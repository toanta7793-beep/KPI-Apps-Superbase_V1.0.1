...
function KpiPage({identity,kpis,kpiWeek,changeKpiWeek,sharedWeeks}:PageProps){
...
function ProductionPage({identity,teams,sharedWeeks,teamFilter,toast}:PageProps){
  ...
  return <ProductionPanel teams={teams} sharedWeeks={sharedWeeks} canUnlock={identity?.role_code==="ADMIN"} defaultTeam={teamFilter} notify={toast}/>;
}
