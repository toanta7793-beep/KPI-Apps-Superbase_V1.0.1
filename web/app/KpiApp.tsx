...
type Kpi = { week_slot:number; team_name:string; start_date:string; end_date:string; day_count:number; total_payroll:number; total_production:number; difference_vnd:number; evaluation:string };
...
type PageId = "home"|"danh-muc-to"|"nhan-su"|"giao-viec"|"danh-gia"|"pgv"|"pgvcnch"|"users"|"danh-muc-gia";
