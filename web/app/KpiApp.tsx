...
export default function KpiApp(){
  ...
  return <div id="app">
    ...
    <aside id="sidebar" className={menuOpen?"open":""}>
      <div className="logo-area"><img className="vincons-logo" src="/project-logo.svg" alt="ĐƠN VỊ THI CÔNG"/><div className="app-title">KPI MEP</div><div className="app-sub">Quản lý Giao Việc & Định Mức MEP</div></div>
