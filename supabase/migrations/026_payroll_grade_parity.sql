-- 026_payroll_grade_and_sheet_job_parity.sql
-- Fix grade recognition for source titles such as "(bậc 2)" and align the
-- single UAT job with the current Sheet row GIAO_VIEC_HOA_VON!4.
